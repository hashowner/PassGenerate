...
class App(CTk.CTk):
    def __init__(self):
        ...
        self.logo = CTk.CTkImage(dark_image=Image.open("icon.png"), size=(460, 150))
    ...
    def change_appearance_mode_event(self, new_appearance_mode):
        ...
        fg_color = "gray" if new_appearance_mode == "System" else "gray"
        self.by_schizxd_label.config(bg=bg_color, fg=fg_color)
